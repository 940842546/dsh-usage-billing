					...
					!s
						...
						: el('div', null,
								el('div', { className: 'usg-ov-stats' },
									todayBucket(s) ? ovStat(T('ov.today'), fmtCostQuick(todayBucket(s).cost) + ' · ' + todayBucket(s).calls + ' ' + T('ov.todayCalls'), 'usg-cost') : ovStat(T('ov.sessions'), String(sessionsCount)),
