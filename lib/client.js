window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const DICTS = {
			...
			'cfg.proRoutes': '官方路由：V4 Pro 已下线并路由到 V4.1 Flash，按 Flash 价计费（9/14 起）',
			...
			'cfg.proRoutes': 'Official routing: V4 Pro retired & routed to V4.1 Flash, billed at Flash rates (since 9/14)',
...
`;
		...
		function draftFromConfig(c) {
			...
			return {
				...
				proRoutes: src.proRoutesToFlash !== false,
