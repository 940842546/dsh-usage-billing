...
.usg-hm-dense .usg-hm-cell { width: 100%; height: 7px; border-radius: 1.5px; }
.usg-hm-dense .usg-hm-grid { gap: 2px; width: 100%; flex: 1 1 0; }
.usg-hm-dense .usg-hm-col { grid-template-rows: repeat(7, 7px); row-gap: 2px; flex: 1 1 0; min-width: 2px; }
