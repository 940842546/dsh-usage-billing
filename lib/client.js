...
`;
		...
		function SessionDetailPanel({ ref, style, data, s, b, sessionId, fmtMoney, budget }) {
			...
			return el('div', {
			ref, role: 'dialog', 'aria-label': T('dock.aria'),
			className: 'usg-sess-panel',
			style: style || { visibility: 'hidden', left: 0, top: 0 },
		},
		...
		function DockReadout(props) {
			...
			return el('span', { className: 'usg-sess-root', ref: rootRef },
				...
				open && el(SessionDetailPanel, { ref: panelRef, style: position, data, s, b, sessionId, fmtMoney, budget }),
			);
		}
