window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const DICTS = {
			zh: {
				'band.before': '8/17 前 · 旧价',
				'band.afterPeak': '8/17 后 · 高峰',
				'band.afterOffPeak': '8/17 后 · 空闲',
				'model.other': '其他模型',
				'common.unknown': '未知',
				'common.detail': '：{msg}',
				'hm.less': '少',
				...
				'set.pricingNote': '调价边界：2026-08-17 00:00（北京时间）；高峰 9:00–12:00、14:00–18:00（北京时间）',
				'set.hit': '命中',
				'set.miss': '未命中',
				'cell.in': '输入',
				'cell.out': '输出',
			...
			en: {
				'band.before': 'Pre 8/17 · legacy price',
				'band.afterPeak': 'Post 8/17 · peak',
				'band.afterOffPeak': 'Post 8/17 · off-peak',
				...
				'set.pricingNote': 'Pricing boundary: 2026-08-17 00:00 (Beijing time); peak 9:00–12:00, 14:00–18:00 (Beijing time)',
				'set.hit': 'Hit',
				'set.miss': 'Miss',
				'cell.in': 'In',
				'cell.out': 'Out',
		...
		function bandLabel(bk) { return T('band.' + bk); }
			...
			return el('div', { className: 'usg-panel' },
				...
				el('details', { className: 'usg-pricing' },
					...
					el('div', { className: 'usg-pricing-body' },
						el('p', { className: 'usg-muted', style: { margin: 0 } }, T('set.pricingNote')),
						el('table', { className: 'usg-table' },
							el('thead', null, el('tr', null,
